...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* FIX: Global Hover Logic for Gold Buttons */
        ...
        /* Unified Table Button Container */
        .btn-group { display: flex; gap: 8px; justify-content: flex-start; }

        /* --- Tables --- */
        .borrow-table { 
            background: rgba(15, 8, 5, 0.6); padding: 30px; 
            border-radius: 16px; margin-bottom: 30px; border: 1px solid rgba(255, 255, 255, 0.05); 
        }
        ...
        /* --- Forms & Panels --- */
        .activity { background: rgba(15, 8, 5, 0.6); padding: 30px; border-radius: 16px; margin-bottom: 30px; border: 1px solid rgba(255, 255, 255, 0.05); }
        ...
        .modal-content { background: #140a05; padding: 40px; border: 1px solid #ffd700; border-radius: 15px; width: 400px; }
        
        .archive-form input, .archive-select { width: 100%; padding: 12px; margin-bottom: 15px; background: rgba(255,255,255,0.05); border: 1px solid rgba(255,215,0,0.3); color: white; border-radius: 5px; outline: none; }
        ...
        .form-actions button[type="submit"] { background: #ffd700; color: #0a0502; flex: 2; }
        ...
        .main::-webkit-scrollbar-thumb { background: rgba(255, 215, 0, 0.2); border-radius: 10px; }
        input[type="date"]::-webkit-calendar-picker-indicator { filter: invert(1); cursor: pointer; }
   
   /* --- Reports Date Filter Styling --- */
.report-controls {
    display: flex;
    align-items: center;
    gap: 12px;
...
.report-controls input[type="date"]::-webkit-calendar-picker-indicator:hover {
    opacity: 1;
}
